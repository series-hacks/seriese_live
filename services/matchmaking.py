...
class MatchmakingService:
    ...
    def __init__(self):
        # Hardcoded lobbies for demo
        self.lobbies = [
            Lobby(
                name="Clash Royale",
                host_name="Raiymbek",
                host_phone="+17186030712",  # From USER_PROFILES in message_handler
                tags=["clash royale", "clash", "cr", "mobile game", "2v2", "playing cr", "mobile games"],
                description="Gaming session - playing Clash Royale"
            ),
            Lobby(
                name="AI Startup Discussion",
                host_name="Ali",
                host_phone="+19297283369",  # From USER_PROFILES in message_handler
                tags=["ai", "startup", "artificial intelligence", "llm", "debating ai", "discussing artificial intelligence", 
                      "talking about startups", "llm stuff", "ai ideas", "startup brainstorming"],
                description="Discussion about AI and startups"
            )
        ]
